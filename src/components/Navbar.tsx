          ...
          <Link to="/" className="hoverable" style={{ display: "flex", alignItems: "center", gap: 20, position: "relative" }}>
            ...
            <div>
              <div style={{ display: "flex", alignItems: "baseline", gap: 10, marginBottom: 2 }}>
                ...
                <div style={{ padding: "3px 10px", background: "var(--red)", color: "var(--cream)", fontSize: 9, fontWeight: 800, letterSpacing: "0.15em", textTransform: "uppercase", borderRadius: 999, fontFamily: "JetBrains Mono, monospace" }}>CUSC</div>
              </div>
